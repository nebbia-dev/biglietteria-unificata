...
export default function EventCard({card, limit, events = []} : EventCardProps) {
    return(
        <>
                            ...
                            <div key={el.documentId} className="w-full md:w-1/3 flex flex-col gap-4 bg-white rounded-xl text-black p-4">
                                ...
                                <div className="flex flex-col gap-2 pl-1">
                                    ...
                                    <div className="flex items-center justify-between mt-4">
                                        ...
                                        <a aria-label={`Vai alla pagina di acquisto di ${el.title}`} target="_blank" rel="noopener noreferrer"
