                            ...
                            <div className="w-full md:w-1/4 text-white rounded-xl gradient"
                                ...
                                <div
                                    ...
                                    <Link
                                        ...
                                        href={`/en/${el.slug}`}>Discover other experiences</Link>
                                </div>
                            </div>
                        )
                    })
                ...
                <div className="p-4 md:p-8 mt-2 flex flex-col md:flex-row md:items-center md:gap-8">
                    <div>
                        ...
                        <p className="text-xl md:text-base font-medium mt-2">
                            Why settle for just one museum? Explore the best of the city and save with our Combined Ticket. This pass grants you access to all museums within the Cremona City Museum Network at a special discounted rate.
                        </p>
                    </div>
                    <div className="flex flex-col gap-4 bg-white rounded-xl text-black p-4 mt-8 mb-4">
        ...
        <section className="w-[90%] md:w-[85%] mx-auto flex md:flex-row flex-col md:gap-8">
            ...
            <div className="w-full md:1/2 pt-8 md:h-full">
                <div className="flex flex-col gap-8 p-4 mt-2 w-full rounded-xl gradient md:h-full">
                    ...
                    />
                    <div className="text-black w-full md:flex md:justify-end font-medium text-sm">
                        <a aria-label="Go to the Musei Italiani website" href="https://www.museiitaliani.it/" target="_blank" rel="noopener noreferrer"
                           className="md:w-fit w-auto block text-center prime-bg rounded-full px-4 py-2">Visit the website</a>
                    </div>
                </div>
            </div>
        </section>
